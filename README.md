...
- The visual behavior is primarily controlled by CSS.
- JavaScript acts as the controller that switches animation states.
- This is a study project, not an original implementation.
